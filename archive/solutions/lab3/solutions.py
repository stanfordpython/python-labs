...
This lab was mostly about exploration and investigating the way functions work
in Python, so there is less "code" per se.

Revision history:
@sredmond 01-23-2019 Updates for Winter 2019
...
def scope(case=1):
    ...
    Read https://docs.python.org/3/reference/executionmodel.html#resolution-of-names for more information.
    """
    if case == 1:
        x = 10
...
if __name__ == '__main__':
    ...
    scope(case=1)
    scope(case=2)
    # Don't run the UnboundLocalError code.
